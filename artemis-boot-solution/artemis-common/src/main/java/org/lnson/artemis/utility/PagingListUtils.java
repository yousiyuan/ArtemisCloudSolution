package org.lnson.artemis.utility;
...
public final class PagingListUtils {
    ...
    public static <T extends Object> List<T> getPagingData(List<T> dataSource, int pageSize, int currentPageIndex, Integer totalPage, Integer totalRecord) {
        if (dataSource == null)
